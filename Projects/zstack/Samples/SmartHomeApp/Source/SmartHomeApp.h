...
// device's needs
#define SmartHomeApp_ENDPOINT           10

#define SmartHomeApp_PROFID             0x0F04
#define SmartHomeApp_DEVICEID           0x0001
#define SmartHomeApp_DEVICE_VERSION     0
#define SmartHomeApp_FLAGS              0

#define SmartHomeApp_MAX_CLUSTERS       1
#define SmartHomeApp_CLUSTERID          1

// Send Message Timeout
#define SmartHomeApp_SEND_MSG_TIMEOUT   5000     // Every 5 seconds
 ...
 */
extern void SmartHomeApp_Init( byte task_id );

/*
 * Task Event Processor for the Generic Application
 */
extern UINT16 SmartHomeApp_ProcessEvent( byte task_id, UINT16 events );
