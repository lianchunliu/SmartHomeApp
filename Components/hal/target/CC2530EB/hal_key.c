...
#define HAL_KEY_SEL    P0SEL
#define HAL_KEY_DIR    P0DIR

/* edge interrupt */
#define HAL_KEY_EDGEBIT  BV(0)
#define HAL_KEY_EDGE     HAL_KEY_FALLING_EDGE


/* SW_6 interrupts */
#define HAL_KEY_IEN      IEN1  /* CPU interrupt mask register */
#define HAL_KEY_IENBIT   BV(5) /* Mask bit for all of Port_0 */
#define HAL_KEY_ICTL     P0IEN /* Port Interrupt Control register */
//#define HAL_KEY_SW_6_ICTLBIT  BV(4) /* P0IEN - P0.1 enable/disable bit */
#define HAL_KEY_PXIFG    P0IFG /* Interrupt flag at source */


#define HAL_KEY_SW_4_PIN P0_4
...
//    P0INP &= ~(HAL_KEY_SW_4_BIT|HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);
//    P0SEL &= ~(HAL_KEY_SW_4_BIT|HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);    /* Set pin function to GPIO */
//    P0DIR &= ~(HAL_KEY_SW_4_BIT|HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);    /* Set pin direction to Input */
//    P2INP &= ~(0x20); // 0010 0000
//   
//    P0INP &= ~(HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);  //0x30 0011 0000
//    P0SEL &= ~(HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);    /* Set pin function to GPIO */
//    P0DIR &= ~(HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);    /* Set pin direction to Input */
//    P2INP &= ~(0x20); // 0010 0000
//    
...
//  
//  HAL_KEY_SEL &= ~(HAL_KEY_SW_5_BIT);    /* Set pin function to GPIO */
//  HAL_KEY_DIR &= ~(HAL_KEY_SW_5_BIT);    /* Set pin direction to Input */
//  
//  HAL_KEY_SEL &= ~(HAL_KEY_SW_6_BIT);    /* Set pin function to GPIO */
//  HAL_KEY_DIR &= ~(HAL_KEY_SW_6_BIT);    /* Set pin direction to Input */
...
//    PICTL &= ~(HAL_KEY_EDGEBIT);    /* Clear the edge bit */
//    /* For falling edge, the bit must be set. */
//  #if (HAL_KEY_EDGE == HAL_KEY_FALLING_EDGE)
//    PICTL |= HAL_KEY_EDGEBIT;
//  #endif
//
//
...
//     */
//    HAL_KEY_ICTL |= (HAL_KEY_SW_4_BIT|HAL_KEY_SW_5_BIT|HAL_KEY_SW_6_BIT);
////    HAL_KEY_ICTL |= HAL_KEY_SW_5_BIT;
////    HAL_KEY_ICTL |= HAL_KEY_SW_6_BIT;
//    HAL_KEY_IEN |= HAL_KEY_IENBIT;
//    
////    HAL_KEY_PXIFG = ~(HAL_KEY_SW_4_BIT | HAL_KEY_SW_5_BIT | HAL_KEY_SW_6_BIT);
//    HAL_KEY_PXIFG = 0;
...
void halProcessKeyInterrupt (void)
{
  ...
  if (HAL_KEY_PXIFG & HAL_KEY_SW_4_BIT)  /* Interrupt Flag has been set */
  {
    HAL_KEY_PXIFG &= ~(HAL_KEY_SW_4_BIT); /* Clear Interrupt Flag */
    valid = TRUE;
  }
  
  if (HAL_KEY_PXIFG & HAL_KEY_SW_5_BIT)  /* Interrupt Flag has been set */
  {
...
HAL_ISR_FUNCTION( halKeyPort0Isr, P0INT_VECTOR )
{
  ...
  if (HAL_KEY_PXIFG & HAL_KEY_SW_4_BIT)
  {
